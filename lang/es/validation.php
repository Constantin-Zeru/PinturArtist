...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas contienen los mensajes de error por defecto que
    | utiliza la clase de validación. Algunas reglas tienen varias versiones,
    | como las reglas de tamaño. Si quieres, puedes ajustar estos mensajes aquí.
    |
    */
    ...
    | convención "attribute.rule". Esto facilita definir mensajes específicos.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para reemplazar el marcador de atributo
    | por algo más legible, como "Correo electrónico" en lugar de "email".
    |
    */
